...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('layanan_group', function (Blueprint $table) {
            ...
            $table->foreign('id_group')->references('id')->on('group')->onDelete('cascade')->onUpdate('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('layanan_group');
    }
};
