    ...
    <table>
        <tr>
            <th colspan="6" style="text-align: center; vertical-align: middle;">
                <b>LAPORAN PELAYANAN BERDASARKAN JENIS KELAMIN</b>
            </th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: center; vertical-align: middle;">
...
border-collapse: collapse; text-align: center; vertical-align: middle; width: 100px;">
        ...
        <tbody>
            @foreach ($data_jenis_kelamin as $key => $jenis_kelamin)
                <tr>
                    ...
                    @foreach ($data_kawasan as $kawasan)
                        <td style="border: 1px solid black; text-align: center; vertical-align: middle;">
                            @php
                                $value = \App\Models\Imigran::where('id_jenis_kelamin', $jenis_kelamin->id)
                    ...
                    <td style="border: 1px solid black; text-align: center; vertical-align: middle;">
                        @php
                            $total_value = \App\Models\Imigran::where('id_jenis_kelamin', $jenis_kelamin->id)
                                ->whereBetween('tanggal_kedatangan', [$start_date, $end_date])
                                ->count();
                        @endphp
