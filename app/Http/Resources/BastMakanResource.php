...
class BastMakanResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'waktu_serah_terima' => $this->waktu_serah_terima,
            'foto_penyedia_jasa' => $this->foto_penyedia_jasa,
            'foto_serah_terima' => $this->foto_serah_terima,
            'foto_invoice' => $this->foto_invoice,
            'terlaksana' => $this->terlaksana,
            'user' => new UserResource($this->user),
            'makan' => MakanResource::collection($this->whenLoaded('makan')),
        ];
    }
}
